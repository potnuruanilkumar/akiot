        ...
        if (c == '\n') {                    // if the byte is a newline character
          ...
          if (currentLine.length() == 0) {
            ...
            if (fanState=="off") {
              ...
              client.println("<p><a href=\"/6/off\"><button class=\"button button2\">bulb OFF</button></a></p>");
            }
            client.println("<p>bulb - State " + bulbState + "</p>");
            // If the fanState is off, it displays the ON button       
            if (bulbState=="off") {
              client.println("<p><a href=\"/6/on\"><button class=\"button\">bulb on</button></a></p>");
            } else {
              client.println("<p><a href=\"/6/off\"><button class=\"button button2\">bulb OFF</button></a></p>");
